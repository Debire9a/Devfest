...
class Breakout(db.Model):
    ...
    breakregdeets = db.relationship('UserRegistration',back_populates="regbreakdeets")
...
class Donation(db.Model):  
    ...
    donate_ref=db.Column(db.String(120),nullable=True) 
    donate_paygate= db.Column(db.String(200),nullable=True)
    donate_date=db.Column(db.DateTime(), default=datetime.utcnow)#default date
...
class UserRegistration(db.Model):
    ...
    regbreakdeets = db.relationship('Breakout',back_populates="breakregdeets")
